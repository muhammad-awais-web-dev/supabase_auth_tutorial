...
const ChatWindow = ({
  ...
  return (
    <div className={`relative flex flex-1 min-w-0 flex-col h-screen items-start justify-center p-10 overflow-hidden ${selectedConversation ? "-translate-x-full lg:translate-x-0" : "translate-x-0"} transition-transform duration-300 ease-in-out `} >
      <div
