...
const page = () => {
  ...
  <div className={`flex flex-row w-full overflow-x-hidden`} >
    <div className={`flex flex-col h-screen overflow-auto min-w-full  lg:min-w-lg items-start justify-start p-10 ${selectedConversation ? "-translate-x-full lg:translate-x-0" : "translate-x-0"} transition-transform duration-300 ease-in-out `} >
